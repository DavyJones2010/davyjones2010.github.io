---
title: K8s kube-scheduler 调度流程分析
...
![Untitled](/_assets/2026-03-04-k8s-kube-scheduler/Untitled.png)

# 调度流程梳理-正常

![Untitled](/_assets/2026-03-04-k8s-kube-scheduler/Untitled-1.png)

- 关键点在上图标红的部分: 实际Bind成功之后, 只watch到了1个PodUpdate事件, 但由于 FilteringResourceEventHandler 的特殊处理, 如下, 会把事件修正为
    - 1个OnAdd事件
    - 1个OnDelete事件

![Untitled](/_assets/2026-03-04-k8s-kube-scheduler/Untitled-2.png)

- 详细trace参见如下: 发现在kube-sched日志中, bind成功后, 触发了 “Delete event” + “Add event”

![Untitled](/_assets/2026-03-04-k8s-kube-scheduler/Untitled-3.png)

# SchedulingQueue处理流程

![Untitled](/_assets/2026-03-04-k8s-kube-scheduler/Untitled-4.png)
