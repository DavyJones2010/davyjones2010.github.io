...
今天不小心刷到一条推送, 提出CloudExit是趋势, 如 [X celebrates 60% savings from cloud exit](https://world.hey.com/dhh/x-celebrates-60-savings-from-cloud-exit-7cc26895) 

大跌眼镜, 遂仔细研读了文中内容. 发现并非夸夸其谈, 而是真正进行了一年多的实践, 有真正的数据. 

# 神奇的人

直接在 [https://dhh.dk/](https://dhh.dk/)  里看DHH的个人简介吧. 
...
不由地想起了之前不小心翻到的另外一位神人lihaoyi的博客: [How to conduct a good Programming Interview](https://www.lihaoyi.com/post/HowtoconductagoodProgrammingInterview.html)
...
- [The HEY Way | HEY](https://www.hey.com/the-hey-way/)
- [Basecamp: Basecamp: Until the End of the Internet](https://basecamp.com/about/policies/until-the-end-of-the-internet)
...
![[RECONSIDER – Signal v. Noise](https://signalvnoise.com/posts/3972-reconsider)](20231031-dhh-and-the-hey-way/Untitled.png)

[RECONSIDER – Signal v. Noise](https://signalvnoise.com/posts/3972-reconsider)

## respect your legacy

[Ta-da List – Until the end of the internet – Signal v. Noise](https://signalvnoise.com/posts/3830-ta-da-list-until-the-end-of-the-internet)
...
与Apple的纠纷: [Apple vs. HEY, antitrust, and monopoly](https://www.hey.com/apple/)

对于Apple强制介入支付:  [Our CEO’s take on Apple’s App Store payment policies | HEY](https://www.hey.com/apple/iap/)

他们的理由是导致他们无法更好地服务用户.  个人也比较关注最终的后续. 

最终的结果: [Apple, HEY, and the path forward](https://www.hey.com/apple/path/)
...
- 在大家普遍认为上云是未来的, 选择了CloudExit这条路:
    - 20230915 CloudExit Summary: [Our cloud exit has already yielded $1m/year in savings](https://world.hey.com/dhh/our-cloud-exit-has-already-yielded-1m-year-in-savings-db358dea)
    - [Twitter is Still Up | REWORK](https://37signals.com/podcast/twitter-is-still-up/)
...
> There are a million metrics you can use to track the health of a  subscription software business like ours. Customer life-time value, cost of acquisition, cohort retention, revenue churn, net promoter score, funnel conversion rates, to name but a few. All useful calculations, but I can't tell you what bliss it's been to steer [37signals](https://37signals.com/) without them for twenty years.
> 

> Half the charm of making something to me is in letting your fingers drive the direction. Without articulation. I've always loved the German word [fingerspitzengefühl](https://en.wikipedia.org/wiki/Fingerspitzengef%C3%BChl) for this concept. Making decisions without needing to rationalize every call with a depth of data.
> 
...
2005~2006: [A design and usability blog: Signal vs. Noise (by 37signals)](https://signalvnoise.com/older_archives.php)

2006~2015: [Signal v. Noise by Basecamp – Business, Design, Programming, and the Web](https://signalvnoise.com/writers/dhh)

2015~2021: [DHH, Author at Signal v. Noise](https://m.signalvnoise.com/author/dhh/)

2021~2023:  [David Heinemeier Hansson](https://world.hey.com/dhh)